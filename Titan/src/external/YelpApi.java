...
public class YelpApi {
	...
	private static final String API_KEY = "lBkPoXa4yhJHy1pLjiKf6zu0zLQerXr6mhjFlq2BnVNaE5rHDOysQYLyNI3PkhG1VqZKfZddkKVBE69VuGEd6dLrz-mtdYlJDUCFOTKn2JuxE5Hl-1xtj7Wdz6TnW3Yx";
	...
	public List<Item> search(double lat, double lon, String term) {
		...
		try {
			...
			if (!object.isNull("businesses")) {
				return getItemList(object.getJSONArray("businesses"));
			}
